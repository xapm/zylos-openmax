...
- **`not_authorized`** (case B — not connected to you): say plainly that {app} isn't connected yet and point them to the **Connections** page (`/connections`) to authorize it; once connected, it can be enabled here. Do not invent another mechanism.
